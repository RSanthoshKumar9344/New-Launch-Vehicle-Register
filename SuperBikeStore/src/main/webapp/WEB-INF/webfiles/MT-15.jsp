...
<body>
    ...
    <div class="scene">
        <div class="bike">
            <img src="https://th.bing.com/th/id/OIP.cvsU7Ln40V-kYpGPQoN9DQAAAA?w=236&h=180&c=7&r=0&o=5&pid=1.7"> <!-- Adjusted image source for higher resolution -->
        </div><br>
    </div><br>
	...
	<a href="Mt">Book Now</a> <!-- Moved the button inside the scene --><br>
